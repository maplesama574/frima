...
@section('css')
<link rel="stylesheet" href="{{asset('css/first-login.css')}}">
@endsection
...
<div class="profile">
    ...
    <div class="profile-content">
        <form action="{{ route('login.first.update') }}" method="POST" enctype="multipart/form-data">
            @csrf
    ...
    @enderror
            ...
            <div class="upload-item">
                ...
                <input class="upload-input" type="text" name="name" value="{{ $user->name }}">
                @error('name')
        <div class="input-error">{{ $message }}</div>
    @enderror
            </div>
